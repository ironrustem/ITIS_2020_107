...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
  ...
  override func viewDidLoad() {
    ...
    contacts?.register(
      UINib(nibName: "ContactTableViewCell", bundle: nil), forCellReuseIdentifier: "cellID")

    UserDefaults.standard.removeObject(forKey: "Contacts")
    UserDefaults.standard.synchronize()

    ContactsClass.share.addContact(
      name: "Rustem", surname: "Saifullin", company: "itis", numbers: ["7787342488"])
    ContactsClass.share.addContact(
      name: "Ramil", surname: "Lelyavin", company: "google", numbers: ["3434324234"])
    ContactsClass.share.addContact(
      name: "Ruslan", surname: "Valeev", company: "yandex", numbers: ["79685764"])
    ContactsClass.share.addContact(
      name: "Rinat", surname: "Vafin", company: "apple", numbers: ["23245678"])
    ContactsClass.share.addContact(
      name: "Railina", surname: "Galieva", company: "samsung", numbers: ["356789076"])
    ContactsClass.share.addContact(
      name: "Aida", surname: "Usmanova", company: "sony", numbers: ["654324578"])
    ContactsClass.share.addContact(
      name: "Danil", surname: "Iliadi", company: "s7", numbers: ["5678976009"])
    ContactsClass.share.addContact(
      name: "Timur", surname: "Batrishin", company: "d5", numbers: ["564356789"])
    ContactsClass.share.addContact(
      name: "Emil", surname: "Fakhreev", company: "amd", numbers: ["778788766546"])
    ContactsClass.share.addContact(
      name: "Edik", surname: "Krmakov", company: "itis", numbers: ["768654678"])
    ContactsClass.share.addContact(
      name: "Alsu", surname: "Shagieva", company: "kfu", numbers: ["77878867765"])
  ...
  func prepareData() {
    ...
    ContactsClass.share.allContacts = ContactsClass.share.allContacts.sorted {
      (con1, con2) -> Bool in
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    let newVC =
      self.storyboard!.instantiateViewController(withIdentifier: "Detail") as! DetailViewController
